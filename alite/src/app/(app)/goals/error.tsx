// filepath: alite/src/app/(app)/goals/error.tsx
'use client'
  ...
  return (
    <div className="min-h-screen bg-background pb-28">
      <div className="max-w-lg mx-auto px-4 pt-16 text-center space-y-4">
        ...
        <h1 className="text-lg font-semibold text-foreground">Couldn&apos;t load your goals</h1>
        <p className="text-sm text-muted-foreground max-w-sm mx-auto">
          Your savings progress is safe — this is a temporary loading issue.
        </p>
