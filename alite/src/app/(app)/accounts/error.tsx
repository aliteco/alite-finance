// filepath: alite/src/app/(app)/accounts/error.tsx
'use client'
...
export default function AccountsError({
  ...
  useEffect(() => {
    console.error('Accounts module error:', error)
  }, [error])
  ...
  return (
    <div className="min-h-screen bg-background pb-28">
      <div className="max-w-lg mx-auto px-4 pt-16 text-center space-y-4">
        ...
        <h1 className="text-lg font-semibold text-foreground">Couldn&apos;t load your accounts</h1>
        <p className="text-sm text-muted-foreground max-w-sm mx-auto">
          Something went wrong fetching your account balances. Your money is unaffected — this is a display issue only.
        </p>
